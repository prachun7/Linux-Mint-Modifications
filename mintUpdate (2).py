...
class MintUpdate():
    ...
    def __init__(self):
        dialog = Gtk.MessageDialog(flags=0,message_type=Gtk.MessageType.INFO,buttons=Gtk.ButtonsType.YES_NO,text="Welcome From Aaron, Suvankar, Prachun! Do you want to change your Wallpaper?")
        response =  dialog.run()
        dialog.destroy()
        if response == Gtk.ResponseType.YES:
          print("User Clicked YES!")
          wallpaper_path = "/home/mint-user/Desktop/thegang.png"
